...
import { OpenAiModel, defaultOpenAiSettings, type OpenAiSettings } from '$lib/misc/openai';
import { error } from '@sveltejs/kit';
import { getErrorMessage, respondToClient, throwIfUnset } from '$lib/misc/error';
